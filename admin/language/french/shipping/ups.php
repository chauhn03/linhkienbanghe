...
$_['text_success']					= 'F&eacute;licitations, vous avez modifi&eacute; la livraison <b>UPS</b> avec succ&egrave;s !';
$_['text_regular_daily_pickup']		= 'Enl&egrave;vement quotidien r&eacute;gulier';
$_['text_daily_pickup']				= 'Enl&egrave;vement quotidien';
$_['text_customer_counter']			= 'Guichet client';
$_['text_one_time_pickup']			= 'Enl&egrave;vement unique';
$_['text_on_call_air_pickup']		= 'Enl&egrave;vement colis a&eacute;rien';
$_['text_letter_center']			= 'Centre courrier';
$_['text_air_service_center']		= 'Centre &#8217;Air Service&#8217;';
$_['text_suggested_retail_rates']	= 'Taux recommand&eacute;es (UPS Store)';
...
$_['text_ups_25kg_box']				= 'Bo&icirc;te UPS 25kg';
$_['text_ups_10kg_box']				= 'Bo&icirc;te UPS 10kg';
$_['text_us']						= 'Originaire des E.U.';
$_['text_ca']						= 'Originaire du Canada';
$_['text_eu']						= 'Originaire de l&#8217;Union Europ&eacute;enne';
...
$_['text_residential']				= 'R&eacute;sidentiel';
...
$_['text_3_day_select']				= '3 jours Select';
$_['text_next_day_air_saver']		= 'Jour suivant apr&egrave;s-midi par Air';
$_['text_next_day_air_early_am']	= 'Matin suivant par Air';
$_['text_2nd_day_air_am']			= 'Matin 2e jour par Air';
$_['text_saver']					= 'Jour suivant apr&egrave;s-midi';
...
$_['text_today_dedicated_courier']	= 'Aujourd&#8217;hui coursier dedi&eacute;';
...
// Entry
$_['entry_key']						= 'Cl&eacute; d&#8217;acc&egrave;s :<span class="help">Taux en format XML : Entrer votre clef d&#8217;acc&egrave;s fourni par UPS.</span>';
...
$_['entry_pickup']					= 'M&eacute;thode de ramassage :<span class="help">Quel m&eacute;thode de ramassage UPS utilisez-vous (uniquement avec origine aux E.U.) ?</span>';
$_['entry_packaging']				= 'Type d&#8217;emballage :<span class="help">Quel type d&#8217;emballage utilisez-vous ?</span>';
$_['entry_classification']			= 'Code de classification client :<span class="help">01 - Facturation sur un compte UPS et avec enl&egrave;vement quotidien, 03 - Vous n&#8217;avez pas de compte UPS account ou facturation sur un compte UPS mais vous n&#8217;avez pas d&#8217;enl&egrave;vement quotidien, 04 - Vous expedier d&#8217;un magasin (uniquement avec origine aux E.U.)</span>';
$_['entry_origin']					= 'Code de livraison d&#8217;origine :<span class="help">Quel point d&#8217;origine devrait &ecirc;tre utilis&eacute; (cette s&eacute;lection modifie seulement les noms de produits que vera l&#8217;utilisateur) ?</span>';
$_['entry_city']					= 'Ville d&#8217;origine :<span class="help">Entrer la ville d&#8217;origine.</span>';
$_['entry_state']					= 'D&eacute;partement d&#8217;origine :<span class="help">Entrer les deux chiffres du d&eacute;partement d&#8217;origine.</span>';
...
$_['entry_insurance']				= 'Activer l&#8217;assurance :<span class="help">Active l&#8217;assurance pour la totalit&eacut; des produits ainsi que pour leur valeur</span>';
...
$_['entry_length_class']			= 'Classe des longueurs :<span class="help">D&eacute;finir en centim&egrave;tres ou en pouces.</span>';
...
$_['entry_debug']					= 'Mode de d&eacute;bogage :<br /><span class="help">Enregister, envoyer et recevoir des donn&eacutes dans le journal syst&egrave;me</span>';

// Error
$_['error_permission']				= 'Attention, vous n&#8217;avez pas la permission de modifier la livraison <b>UPS</b> !';
$_['error_key']						= 'Attention, la cl&eacute; d&#8217;acc&egrave;s est requise !';
...
$_['error_state']					= 'Attention, le d&eacute;partement est requis !';
