...
$_['text_guide_seo'] = 'So aktivieren Sie SEO';
$_['text_guide_category'] = 'Kategorie verwalten';
...
$_['entry_default_column_width'] = 'Standard- Spaltenbreite ( Spanx ) :';
$_['entry_columns'] = 'Spalten';
$_['entry_detail_columns'] = 'Detail Spalten Breite ';
$_['entry_sub_menutype'] = 'Sub Menu Type';
$_['entry_submenu_content'] = 'UntermenÃ¼ Inhalt';
$_['text_none'] = 'Keine';
$_['text_explain_input_html'] = 'Wenn MenÃ¼ Inhalt ist HTML , so dass alle UntermenÃ¼s zu diesem MenÃ¼ nicht gezeigt werden ';
$_['text_explain_input_auto'] = 'Geben Sie Buchstaben oder ein Wort aus';
$_['text_explain_submenu_cols'] = 'Geben Sie Breite jedes Detail in subcols Werte 1 -> 12 <br> Beispiel: . col1 = 3 col3 = 5';
$_['text_explain_submenu_type'] = 'Wenn der Typ MenÃ¼ , so UntermenÃ¼s wird dies gezeigt werden ';
...
$_['module_latest'] = 'Blog Neueste';
$_['module_comment'] = 'Blog-Kommentar ';
$_['module_category'] = 'Blog Kategorie MenÃ¼ ';
$_['text_modules_urls'] = 'URLs Format ';

$_['latest_blog'] = 'Letzte Blog';
...
$_['databroad_add_blog'] = 'HinzufÃ¼gen Blog';
...
$_['text_username'] = 'Benutzer';
$_['text_email'] = 'E-Mail ';
$_['button_publish'] = 'publish ';
$_['button_unpublish'] = 'UnverÃ¶ffentlichungs ';
$_['text_status'] = 'Status';
$_['text_enable'] = 'Aktivieren';
$_['text_confirm_delete'] = 'Sind Sie sicher, dass dies wirklich lÃ¶schen? ';
...
$_['text_general_setting'] = 'Allgemeine Einstellungen ';
$_['entry_large_image_demension'] = 'Blog - GroÃŸes Bild Demension ( Breite x HÃ¶he )';
$_['entry_small_image_demension'] = 'Blog - Small Image Demension ( Breite x HÃ¶he )';
$_['entry_xsmall_image_demension'] = 'Blog - XSmall Bild Demension ( Breite x HÃ¶he )';
$_['entry_rss_limit'] = 'Limit- Blogs In RSS';
$_['text_category_setting'] = 'Kategorie Seite Setting';
$_['entry_limit_leading_blogs'] = 'Grenze Leading Blogs ';
$_['entry_limit_secondary_blogs'] = 'Grenze Secondary Blogs ';
$_['entry_leading_image_types'] = 'Bild -Typen ';
$_['text_large_image'] = 'GroÃŸes Bild ';
$_['text_small_image'] = 'Small Image ';
$_['entry_limit_secondary_blogs'] = 'Grenze Secondary Blogs ';
$_['entry_secondary_image_types'] = 'Secondary Bild Types ';
$_['entry_show_title'] = 'Titel anzeigen ';
$_['entry_show_image'] = 'Bild anzeigen ';
$_['entry_show_author'] = 'Zeige Autor ';
$_['entry_show_category'] = 'Zeige Kategorie ';
$_['entry_show_created'] = 'Zeige Erstellungsdatum ';
$_['entry_show_comment_counter'] = 'Zeige Kommentar ZÃ¤hler ';
$_['entry_show_description'] = 'Beschreibung anzeigen ';
$_['entry_show_readmore'] = 'Zeige Readmore ';
$_['entry_show_hits'] = 'Zeige Hits ';
$_['text_blog_setting'] = 'Blog Setting';
$_['entry_blog_image_types'] = 'Blog Bild-Typ ';
$_['blog_secondary_image_types'] = 'Secondary Bild Types ';
$_['blog_show_title'] = 'Titel anzeigen ';
$_['blog_show_image'] = 'Bild anzeigen ';
$_['blog_show_author'] = 'Zeige Autor ';
$_['blog_show_category'] = 'Zeige Kategorie ';
$_['blog_show_created'] = 'Zeige Erstellungsdatum ';
$_['blog_show_comment_counter'] = 'Zeige Kommentar ZÃ¤hler ';
$_['entry_show_comment_form'] = 'Zeige Kommentar Form';

$_['text_modules_setting'] = 'Module einstellen ';

$_['text_categories_module'] = 'Kategorien MenÃ¼ Module ';
$_['text_latest_blog_module'] = 'Letzte Blog Module ';
$_['text_latest_comment_module'] = 'Letzte Kommentar Module ';

$_['entry_columns_secondary_blogs'] = 'Spalten Secondary Blogs ';
...
$_['entry_comment_limit'] = 'Grenze Kommentar ';
$_['entry_facebook_width'] = 'Facebook Width';
$_['entry_auto_publish_comment'] = 'Auto Publish Kommentar';

$_['entry_enable_recaptcha'] = 'Aktivieren WÃ¶rter sind ';
$_['entry_recaptcha_public_key'] = 'Public -WÃ¶rter sind ';
$_['entry_recaptcha_private_key'] = 'Private Key ';
$_['text_register_recaptcha'] = 'Register Recaptcha ';
$_['tab_pavblogcategory'] = 'Kategorie Modul Setting';
$_['tab_pavblogcomment'] = 'Letzte Kommentar Modul Setting';
